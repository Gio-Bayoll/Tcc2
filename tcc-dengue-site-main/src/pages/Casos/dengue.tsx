...
const Dengue: React.FC = () => {
  ...
  async function fetchDengue() {
    try {
      const response = await axios.get("http://localhost:3000/disease/Dengue");
  ...
  return (
    <div className="mx-auto container">
      ...
      <div className="flex flex-col items-center justify-center">
        <h3 className="font-semibold my-4 text-3xl">Dengue</h3>
        <div>
