...
const Chikungunya: React.FC = () => {
  const [chartData, setChartData] = useState<ChartDataItem[]>([]);
  const [dados, setDados] = useState<DiseaseStats[]>([]);

  async function fetchChikun() {
    try {
      const response = await axios.get("http://localhost:3000/disease/Chikun");
  ...
  return (
    <div className="mx-auto container">
      ...
      <div className="flex flex-col items-center justify-center">
        <h3 className="font-semibold my-4 text-3xl">Chikungunya</h3>
        <div>
          ...
          <Card className="flex flex-col">
            <CardHeader className="items-center pb-0">
              <CardTitle>Casos de Dengue Confirmados</CardTitle>
